...
13. A. 32, + with a string will be a concatenation
13. B. 1, - forces a '3' to be a numeric type = numeric conversion
13. C. 3, null = 0
13. D. 3null, + with a string will be a concatenation
13. E. 4, true = 1 so 1 + 3 = 4
13. F. 0, false = null = 0
13. G. 3undefined, + with a string will be a concatenation
13. H. NaN, undefined is missing value = NaN so 3 minus a NaN is NaN

14. A. true, string '2' becomes a number 2
14. B. false, both strings 2 is greater than 1
14. C. true, '2' becomes a number 2, so equal
14. D. true , checks type and value and they are the same so true
14. E. false, true = 1 so its not equal
14. F. true, Boolean(2) is true because any non zero in Boolean() is true
